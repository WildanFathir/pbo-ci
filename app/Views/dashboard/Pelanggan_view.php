        ...
        <div class="main-content">
            ...
            <div class="page-content">
                <div class="button-group" style="margin-bottom: 8px;">
                    ...
                    <a href="<?= base_url('dashboard/pelanggan/cetak') ?>" target="_blank" role="button" class="btn btn-yellow" data-toggle="modal">Cetak PDF</a>
            ...
            <!-- Modal Tambah -->
            <form name="modal_form1" method="post" enctype="multipart/form-data" action="<?= base_url('dashboard/pelanggan/simpan') ?>" onsubmit="return cek_inputan()">
            ...
            <!-- Modal Edit -->
            <form name="modal_form2" method="post" enctype="multipart/form-data" action="<?= base_url('dashboard/pelanggan/edit') ?>" onsubmit="return cek_inputan_edit()">
