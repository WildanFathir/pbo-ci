        ...
        <div class="main-content">
            ...
            <div class="page-content">
                <div class="button-group" style="margin-bottom: 8px;">
                    ...
                    <a href="<?= base_url('dashboard/merk_produk/cetak') ?>" target="_blank" role="button" class="btn btn-yellow" data-toggle="modal">Cetak PDF</a>
            ...
            <!-- Modal Tambah -->
            <form name="modal_form1" method="post" enctype="multipart/form-data" action="<?= base_url('dashboard/merk_produk/simpan') ?>" onsubmit="return cek_inputan()">
            ...
            <!-- Modal Edit -->
            <form name="modal_form2" method="post" enctype="multipart/form-data" action="<?= base_url('dashboard/merk_produk/edit') ?>" onsubmit="return cek_inputan_edit()">
