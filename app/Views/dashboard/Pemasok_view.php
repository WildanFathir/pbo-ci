        ...
        <div class="main-content">
                ...
                <div class="row-fluid">
                    <table id="sample-table-2" class="table table-striped table-bordered table-hover">
                        ...
                        <tbody>
                            <?php if (!empty($data_pemasok)): ?>
                                ...
                                foreach ($data_pemasok as $pemasok): ?>
                                    <tr>
                                        ...
                                        <td class="center"><?= esc($pemasok['no_pemasok']) ?></td>
                                        <td class="center"><?= esc($pemasok['nama_pemasok']) ?></td>
                                        <td class="center"><?= esc($pemasok['no_telp']) ?></td>
                                        <td class="center"><?= esc($pemasok['alamat']) ?></td>
                                        <td class="center">
                                            <img width="100px" src="<?= base_url('assets/pemasok/' . esc($pemasok['foto'])) ?>" alt="Foto Pemasok">
                                        </td>
                                        <td class="td-actions">
                                            <a class="green btn_edit" title="Edit Data" href="#"
                                                data-no_pemasok="<?= $pemasok['no_pemasok'] ?>"
                                                data-nama_pemasok="<?= $pemasok['nama_pemasok'] ?>"
                                                data-no_telp="<?= $pemasok['no_telp'] ?>"
                                                data-alamat="<?= $pemasok['alamat'] ?>"
                                                data-foto="<?= $pemasok['foto'] ?>">
                            ...
                            <?php else: ?>
                                <tr>
                                    <td class="center" colspan="7">Data pemasok belum tersedia</td>
                                </tr>
                            <?php endif ?>
                        </tbody>
                    </table>
            ...
            <form name="modal_form1" method="post" enctype="multipart/form-data" action="<?= route_to('simpanPemasok') ?>" onsubmit="return cek_inputan()">
                <div id="modal-form" class="modal hide" tabindex="-1">
                    <div class="modal-header">
                        ...
                        <h4 class="blue bigger">Tambah Data Pemasok</h4>
                    </div>
                        ...
                        <div class="row-fluid">
                            ...
                            <div class="span7">
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input class="input-small span12" type="text" id="no_pemasok" name="no_pemasok" readonly value="<?= esc($nomor_otomatis) ?>" />
                                    </div>
                                </div>
                                <div class="control-group">
                                    <label class="control-label" for="nama_pemasok">Nama Pemasok</label>
                                    <div class="controls">
                                        <input class="input-small span12" type="text" id="nama_pemasok" name="nama_pemasok" placeholder="Masukan nama pemasok" />
                                    </div>
                                </div>
                                <div class="control-group">
            ...
            <form name="modal_form2" method="post" enctype="multipart/form-data" action="<?= route_to('editPemasok') ?>" onsubmit="return cek_inputan_edit()">
                <div id="modal-form2" class="modal hide" tabindex="-1">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal">&times;</button>
                        <h4 class="blue bigger">Edit Data Pemasok</h4>
                    </div>
                    <div class="modal-body overflow-scroll">
                        <div class="row-fluid">
                            <div class="span5">
                            ...
                            <div class="span7">
                                <div class="control-group">
                                    <label class="control-label" for="no_pemasok">No Pemasok</label>
                                    <div class="controls">
                                        <input class="input-small span12 no_pemasok" type="text" id="no_pemasok" name="no_pemasok_edit" readonly value="" />
                                    </div>
                                </div>
                                <div class="control-group">
                                    <label class="control-label" for="nama_pemasok">Nama Pemasok</label>
                                    <div class="controls">
                                        <input class="input-small span12 nama_pemasok" type="text" id="nama_pemasok" name="nama_pemasok_edit" placeholder="Masukan nama pemasok" />
                                    </div>
                                </div>
                                <div class="control-group">
                                    <label class="control-label" for="no_telp">No Telp</label>
    ...
    <script>
        $(document).ready(function() {
            $('.btn_hapus').on('click', function() {
                ...
                bootbox.confirm(nama_pemasok + " akan dihapus?", function(result) {
                    if (result) {
                        window.location.href = "<?= base_url('dashboard/pemasok/hapus/'); ?>" + no_pemasok;
                    }
                });
            });
            ...
            $('.btn_edit').on('click', function() {
                ...
                $('.no_telp').val(no_telp);
                $('.alamat').val(alamat);
                document.modal_form2.vfoto.src = "<?= base_url('assets/pemasok/'); ?>" + foto;
